...
echo '
<head>
  <title>Donors Medical Report</title>
  <meta charset="utf-8">
...
echo "<nav class='navbar navbar-expand-sm bg-light navbar-light'>
        ...
        <ul class='navbar-nav'>
            ...
            <li class='nav-item'>
                <a class='nav-link' href='d_med_report.php'>Donors Medical History</a>
            </li>
        </ul>
    </div>
  </span>
...
$sql = "SELECT * FROM Donor_med_report;";
$result = $conn->query($sql);
$return_arr = array();

echo "<div class='container'><form style= 'display:none'>
<input type='text'></form><br><h1>Donors Medical Report </h1></div>";
