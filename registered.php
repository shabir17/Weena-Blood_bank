...
echo "<nav class='navbar navbar-expand-sm bg-light navbar-light'>
        ...
        <ul class='navbar-nav'>
            ...
            <li class='nav-item'>
                <a class='nav-link' href='Patients.php'>Patients Registered</a>
            </li>
            <li class='nav-item'>
                <a class='nav-link' href='branch.php'>Patients Registered Branch</a>
            </li>
        </ul>
    </div>
  </span>
...
<input type='text'></form><br><h1>Registered Patients </h1></div>";
