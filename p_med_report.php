...
echo '
<head>
  <title>Patients Medical Report</title>
  <meta charset="utf-8">
...
echo "<nav class='navbar navbar-expand-sm bg-light navbar-light'>
        ...
        <ul class='navbar-nav'>
            ...
            <li class='nav-item'>
                <a class='nav-link' href='p_med_report.php'>Patients Medical History</a>
            </li>
        </ul>
    </div>
  </span>
...
$sql = "SELECT * FROM Patients_med_report;";
$result = $conn->query($sql);
$return_arr = array();

echo "<div class='container'><form style= 'display:none'>
<input type='text'></form><br><h1>Patients Medical Report </h1></div>";
...
<td><strong>Preexisting conditions </strong></td>
